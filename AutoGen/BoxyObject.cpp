...
double
BoxyObject::gethasBox_Height ()
{
  return hasBox_Height;
}

double
BoxyObject::gethasBox_Width ()
{
  return hasBox_Width;
}

double
BoxyObject::gethasBox_Length ()
{
...
void
BoxyObject::sethasBox_Height (double _hasBox_Height)
{
  this->hasBox_Height = _hasBox_Height;
}

void
BoxyObject::sethasBox_Width (double _hasBox_Width)
{
  this->hasBox_Width = _hasBox_Width;
}

void
BoxyObject::sethasBox_Length (double _hasBox_Length)
{
  this->hasBox_Length = _hasBox_Length;
}

void
BoxyObject::setdao (DAO * _dao)
{
  this->dao = _dao;
}

void
BoxyObject::get (std::string name)
{
...
void
BoxyObject::set (std::string name)
{
...
void
BoxyObject::copy (std::map < std::string, std::string > object)
{
