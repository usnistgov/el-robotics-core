...
bool BoxyShape::gethasBoxyShape_Top(){
return hasBoxyShape_Top;
}
...
void BoxyShape::sethasBoxyShape_Top(bool _hasBoxyShape_Top){
this->hasBoxyShape_Top= _hasBoxyShape_Top;
}
...
this->hasBoxyShape_Top = std::atof(object["BoxyShape.hasBoxyShape_Top"].c_str());
