...
void DAO::fillGetSqlQueries(){std::vector<std::string> temp;DAO::getSqlQueriesDataSingle["Robot"] = "SELECT Robot.RobotID AS 'Robot.RobotID', Robot._NAME AS 'Robot._NAME', Robot.hasRobot_Description AS 'Robot.hasRobot_Description', Robot.hasRobot_MaximumLoadWeight AS 'Robot.hasRobot_MaximumLoadWeight' FROM Robot, NoSkuObject, SolidObject WHERE  Robot.RobotID = ? AND NoSkuObject.NoSkuObjectID = Robot.RobotID AND SolidObject.SolidObjectID = Robot.RobotID";
DAO::getSqlQueriesDataSingle["MechanicalComponent"] = "SELECT MechanicalComponent.MechanicalComponentID AS 'MechanicalComponent.MechanicalComponentID', MechanicalComponent._NAME AS 'MechanicalComponent._NAME' FROM MechanicalComponent, NoSkuObject, SolidObject WHERE  MechanicalComponent.MechanicalComponentID = ? AND NoSkuObject.NoSkuObjectID = MechanicalComponent.MechanicalComponentID AND SolidObject.SolidObjectID = MechanicalComponent.MechanicalComponentID";
DAO::getSqlQueriesDataSingle["Kit"] = "SELECT Kit.KitID AS 'Kit.KitID', Kit._NAME AS 'Kit._NAME', Kit.hasKit_Finished AS 'Kit.hasKit_Finished' FROM Kit, NoSkuObject, SolidObject WHERE  Kit.KitID = ? AND NoSkuObject.NoSkuObjectID = Kit.KitID AND SolidObject.SolidObjectID = Kit.KitID";
DAO::getSqlQueriesDataSingle["Human"] = "SELECT Human.HumanID AS 'Human.HumanID', Human._NAME AS 'Human._NAME' FROM Human, NoSkuObject, SolidObject WHERE  Human.HumanID = ? AND NoSkuObject.NoSkuObjectID = Human.HumanID AND SolidObject.SolidObjectID = Human.HumanID";
...
DAO::getSqlQueriesDataSingle["NoSkuObject"] = "SELECT NoSkuObject.NoSkuObjectID AS 'NoSkuObject.NoSkuObjectID', NoSkuObject._NAME AS 'NoSkuObject._NAME' FROM NoSkuObject, SolidObject WHERE  NoSkuObject.NoSkuObjectID = ? AND SolidObject.SolidObjectID = NoSkuObject.NoSkuObjectID";
DAO::getSqlQueriesDataSingle["LargeBoxWithKits"] = "SELECT LargeBoxWithKits.LargeBoxWithKitsID AS 'LargeBoxWithKits.LargeBoxWithKitsID', LargeBoxWithKits._NAME AS 'LargeBoxWithKits._NAME', LargeBoxWithKits.hasLargeBoxWithKits_Capacity AS 'LargeBoxWithKits.hasLargeBoxWithKits_Capacity' FROM LargeBoxWithKits, NoSkuObject, SolidObject WHERE  LargeBoxWithKits.LargeBoxWithKitsID = ? AND NoSkuObject.NoSkuObjectID = LargeBoxWithKits.LargeBoxWithKitsID AND SolidObject.SolidObjectID = LargeBoxWithKits.LargeBoxWithKitsID";
DAO::getSqlQueriesDataSingle["PartsVessel"] = "SELECT PartsVessel.PartsVesselID AS 'PartsVessel.PartsVesselID', PartsVessel._NAME AS 'PartsVessel._NAME', PartsVessel.hasPartsVessel_PartQuantity AS 'PartsVessel.hasPartsVessel_PartQuantity', PartsVessel.hasPartsVessel_SerialNumber AS 'PartsVessel.hasPartsVessel_SerialNumber' FROM PartsVessel, SkuObject, SolidObject WHERE  PartsVessel.PartsVesselID = ? AND SkuObject.SkuObjectID = PartsVessel.PartsVesselID AND SolidObject.SolidObjectID = PartsVessel.PartsVesselID";
...
DAO::getSqlQueriesDataSingle["SkuObject"] = "SELECT SkuObject.SkuObjectID AS 'SkuObject.SkuObjectID', SkuObject._NAME AS 'SkuObject._NAME' FROM SkuObject, SolidObject WHERE  SkuObject.SkuObjectID = ? AND SolidObject.SolidObjectID = SkuObject.SkuObjectID";
DAO::getSqlQueriesDataSingle["Part"] = "SELECT Part.PartID AS 'Part.PartID', Part._NAME AS 'Part._NAME', Part.hasPart_SerialNumber AS 'Part.hasPart_SerialNumber' FROM Part, SkuObject, SolidObject WHERE  Part.PartID = ? AND SkuObject.SkuObjectID = Part.PartID AND SolidObject.SolidObjectID = Part.PartID";
...
DAO::getSqlQueriesDataSingle["PartsBin"] = "SELECT PartsBin.PartsBinID AS 'PartsBin.PartsBinID', PartsBin._NAME AS 'PartsBin._NAME', PartsVessel.hasPartsVessel_PartQuantity AS 'PartsVessel.hasPartsVessel_PartQuantity', PartsVessel.hasPartsVessel_SerialNumber AS 'PartsVessel.hasPartsVessel_SerialNumber' FROM PartsBin, PartsVessel, SkuObject, SolidObject WHERE  PartsBin.PartsBinID = ? AND PartsVessel.PartsVesselID = PartsBin.PartsBinID AND SkuObject.SkuObjectID = PartsBin.PartsBinID AND SolidObject.SolidObjectID = PartsBin.PartsBinID";
DAO::getSqlQueriesDataSingle["GripperEffector"] = "SELECT GripperEffector.GripperEffectorID AS 'GripperEffector.GripperEffectorID', GripperEffector._NAME AS 'GripperEffector._NAME', EndEffector.hasEndEffector_Description AS 'EndEffector.hasEndEffector_Description', EndEffector.hasEndEffector_Weight AS 'EndEffector.hasEndEffector_Weight', EndEffector.hasEndEffector_MaximumLoadWeight AS 'EndEffector.hasEndEffector_MaximumLoadWeight' FROM GripperEffector, EndEffector, NoSkuObject, SolidObject WHERE  GripperEffector.GripperEffectorID = ? AND EndEffector.EndEffectorID = GripperEffector.GripperEffectorID AND NoSkuObject.NoSkuObjectID = GripperEffector.GripperEffectorID AND SolidObject.SolidObjectID = GripperEffector.GripperEffectorID";
...
DAO::getSqlQueriesDataSingle["WorkTable"] = "SELECT WorkTable.WorkTableID AS 'WorkTable.WorkTableID', WorkTable._NAME AS 'WorkTable._NAME' FROM WorkTable, NoSkuObject, SolidObject WHERE  WorkTable.WorkTableID = ? AND NoSkuObject.NoSkuObjectID = WorkTable.WorkTableID AND SolidObject.SolidObjectID = WorkTable.WorkTableID";
DAO::getSqlQueriesDataSingle["EndEffectorChangingStation"] = "SELECT EndEffectorChangingStation.EndEffectorChangingStationID AS 'EndEffectorChangingStation.EndEffectorChangingStationID', EndEffectorChangingStation._NAME AS 'EndEffectorChangingStation._NAME' FROM EndEffectorChangingStation, NoSkuObject, SolidObject WHERE  EndEffectorChangingStation.EndEffectorChangingStationID = ? AND NoSkuObject.NoSkuObjectID = EndEffectorChangingStation.EndEffectorChangingStationID AND SolidObject.SolidObjectID = EndEffectorChangingStation.EndEffectorChangingStationID";
DAO::getSqlQueriesDataSingle["LargeBoxWithEmptyKitTrays"] = "SELECT LargeBoxWithEmptyKitTrays.LargeBoxWithEmptyKitTraysID AS 'LargeBoxWithEmptyKitTrays.LargeBoxWithEmptyKitTraysID', LargeBoxWithEmptyKitTrays._NAME AS 'LargeBoxWithEmptyKitTrays._NAME' FROM LargeBoxWithEmptyKitTrays, NoSkuObject, SolidObject WHERE  LargeBoxWithEmptyKitTrays.LargeBoxWithEmptyKitTraysID = ? AND NoSkuObject.NoSkuObjectID = LargeBoxWithEmptyKitTrays.LargeBoxWithEmptyKitTraysID AND SolidObject.SolidObjectID = LargeBoxWithEmptyKitTrays.LargeBoxWithEmptyKitTraysID";
DAO::getSqlQueriesDataSingle["PartsTray"] = "SELECT PartsTray.PartsTrayID AS 'PartsTray.PartsTrayID', PartsTray._NAME AS 'PartsTray._NAME', PartsVessel.hasPartsVessel_PartQuantity AS 'PartsVessel.hasPartsVessel_PartQuantity', PartsVessel.hasPartsVessel_SerialNumber AS 'PartsVessel.hasPartsVessel_SerialNumber' FROM PartsTray, PartsVessel, SkuObject, SolidObject WHERE  PartsTray.PartsTrayID = ? AND PartsVessel.PartsVesselID = PartsTray.PartsTrayID AND SkuObject.SkuObjectID = PartsTray.PartsTrayID AND SolidObject.SolidObjectID = PartsTray.PartsTrayID";
...
DAO::getSqlQueriesDataSingle["KittingWorkstation"] = "SELECT KittingWorkstation.KittingWorkstationID AS 'KittingWorkstation.KittingWorkstationID', KittingWorkstation._NAME AS 'KittingWorkstation._NAME', KittingWorkstation.hasKittingWorkstation_LengthUnit AS 'KittingWorkstation.hasKittingWorkstation_LengthUnit', KittingWorkstation.hasKittingWorkstation_WeightUnit AS 'KittingWorkstation.hasKittingWorkstation_WeightUnit', KittingWorkstation.hasKittingWorkstation_AngleUnit AS 'KittingWorkstation.hasKittingWorkstation_AngleUnit' FROM KittingWorkstation, NoSkuObject, SolidObject WHERE  KittingWorkstation.KittingWorkstationID = ? AND NoSkuObject.NoSkuObjectID = KittingWorkstation.KittingWorkstationID AND SolidObject.SolidObjectID = KittingWorkstation.KittingWorkstationID";
DAO::getSqlQueriesDataSingle["KitTray"] = "SELECT KitTray.KitTrayID AS 'KitTray.KitTrayID', KitTray._NAME AS 'KitTray._NAME', KitTray.hasKitTray_SerialNumber AS 'KitTray.hasKitTray_SerialNumber' FROM KitTray, SkuObject, SolidObject WHERE  KitTray.KitTrayID = ? AND SkuObject.SkuObjectID = KitTray.KitTrayID AND SolidObject.SolidObjectID = KitTray.KitTrayID";
...
DAO::getSqlQueriesDataSingle["LargeContainer"] = "SELECT LargeContainer.LargeContainerID AS 'LargeContainer.LargeContainerID', LargeContainer._NAME AS 'LargeContainer._NAME', LargeContainer.hasLargeContainer_SerialNumber AS 'LargeContainer.hasLargeContainer_SerialNumber' FROM LargeContainer, SkuObject, SolidObject WHERE  LargeContainer.LargeContainerID = ? AND SkuObject.SkuObjectID = LargeContainer.LargeContainerID AND SolidObject.SolidObjectID = LargeContainer.LargeContainerID";
...
temp.clear();temp.push_back("InternalShape/hasNoSkuObject_InternalShape");
temp.push_back("-ExternalShape/hadByExternalShape_NoSkuObject");
DAO::getSqlQueriesObjectSingle["NoSkuObject"] = temp;
temp.clear();temp.push_back("StockKeepingUnit/hasPartsVessel_PartSku");
temp.push_back("-Part/hadByPart_PartsVessel");
DAO::getSqlQueriesObjectSingle["PartsVessel"] = temp;
...
temp.push_back("WorkTable/hadByObjectOnTable_WorkTable");
...
temp.clear();temp.push_back("StockKeepingUnit/hadByExternalShape_StockKeepingUnit");
temp.push_back("NoSkuObject/hadByExternalShape_NoSkuObject");
DAO::getSqlQueriesObjectSingle["ExternalShape"] = temp;
temp.clear();temp.push_back("-NoSkuObject/hasNoSkuObject_InternalShape");
temp.push_back("-StockKeepingUnit/hasStockKeepingUnit_InternalShape");
...
temp.clear();temp.push_back("StockKeepingUnit/hasSkuObject_Sku");
DAO::getSqlQueriesObjectSingle["SkuObject"] = temp;
temp.clear();temp.push_back("-Slot/hasSlot_Part");
temp.push_back("PartsVessel/hadByPart_PartsVessel");
...
temp.clear();temp.push_back("-PartsVessel/hasPartsVessel_PartSku");
temp.push_back("-SkuObject/hasSkuObject_Sku");
temp.push_back("-ExternalShape/hadByExternalShape_StockKeepingUnit");
temp.push_back("-PartRefAndPose/hasPartRefAndPose_Sku");
temp.push_back("KittingWorkstation/hadBySku_KittingWorkstation");
temp.push_back("InternalShape/hasStockKeepingUnit_InternalShape");
...
temp.clear();temp.push_back("-SolidObject/hadByObjectOnTable_WorkTable");
