...
private:
  ...
  static std::map < std::string,
    std::vector < std::string > >getSqlQueriesDataMulti;
  static std::map < std::string,
    std::vector < std::string > >getSqlQueriesObjectSingle;
  static std::map < std::string,
    std::vector < std::string > >getSqlQueriesObjectMulti;
  static std::map < std::string, std::vector < std::string > >setSqlQueries;
  static std::map < std::string,
    std::vector < std::string > >updateSqlQueries;
