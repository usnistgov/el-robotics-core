...
void
DataThing::setdao (DAO * _dao)
{
  this->dao = _dao;
}

void
DataThing::get (std::string name)
{
...
void
DataThing::copy (std::map < std::string, std::string > object)
{
...
} std::vector < std::string > DataThing::Explode (const std::string & str,
						  char separator)
{
