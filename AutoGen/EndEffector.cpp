...
double
EndEffector::gethasEndEffector_Weight ()
{
  return hasEndEffector_Weight;
}

double
EndEffector::gethasEffector_MaximumLoadWeight ()
{
...
void
EndEffector::sethasEndEffector_Description (std::
					    string
					    _hasEndEffector_Description)
{
  this->hasEndEffector_Description = _hasEndEffector_Description;
}

void
EndEffector::sethasEndEffector_Weight (double _hasEndEffector_Weight)
{
...
void
EndEffector::
sethasEffector_MaximumLoadWeight (double _hasEffector_MaximumLoadWeight)
{
  this->hasEffector_MaximumLoadWeight = _hasEffector_MaximumLoadWeight;
}

void
EndEffector::sethasEndEffector_Id (std::string _hasEndEffector_Id)
{
  this->hasEndEffector_Id = _hasEndEffector_Id;
}

void
EndEffector::setdao (DAO * _dao)
{
  this->dao = _dao;
}

void
EndEffector::sethadByEndEffector_Robot (Robot * _hadByEndEffector_Robot)
{
  this->hadByEndEffector_Robot = _hadByEndEffector_Robot;
}

void
EndEffector::sethasEndEffectorHolder_EndEffector (EndEffectorHolder *
...
void
EndEffector::get (std::string name)
{
...
void
EndEffector::set (std::string name)
{
  ...
  if (hasEndEffectorHolder_EndEffector != NULL)
    data["hasEndEffectorHolder_EndEffector"] =
      hasEndEffectorHolder_EndEffector->getname ();
  dao = new DAO ("EndEffector");
  dao->set (data);
  delete (dao);
}
...
void
EndEffector::copy (std::map < std::string, std::string > object)
{
  ...
  this->hasEndEffector_Description =
    object["EndEffector.hasEndEffector_Description"];
  this->hasEndEffector_Weight =
    std::atof (object["EndEffector.hasEndEffector_Weight"].c_str ());
  this->hasEffector_MaximumLoadWeight =
    std::atof (object["EndEffector.hasEffector_MaximumLoadWeight"].c_str ());
  this->hasEndEffector_Id = object["EndEffector.hasEndEffector_Id"];
  this->name = object["EndEffector._NAME"];
  this->EndEffectorID =
    std::atof (object["EndEffector.EndEffectorID"].c_str ());
  if (this->hadByEndEffector_Robot == NULL
      && object["hadByEndEffector_Robot/Robot._NAME"] != "")
    {
      this->hadByEndEffector_Robot =
	new Robot (object["hadByEndEffector_Robot/Robot._NAME"]);
    }
  if (this->hasEndEffectorHolder_EndEffector == NULL
      && object["hasEndEffectorHolder_EndEffector/EndEffectorHolder._NAME"] !=
      "")
    {
      this->hasEndEffectorHolder_EndEffector =
	new
	EndEffectorHolder (object
			   ["hasEndEffectorHolder_EndEffector/EndEffectorHolder._NAME"]);
    }

}

std::vector < std::string > EndEffector::Explode (const std::string & str,
						  char separator)
{
