...
class EndEffector:public SolidObject
{
private:
...
public:
  ...
  void sethasEndEffector_Description (std::
				      string _hasEndEffector_Description);
  ...
  void sethasEffector_MaximumLoadWeight (double
					 _hasEffector_MaximumLoadWeight);
  ...
  void sethasEndEffectorHolder_EndEffector (EndEffectorHolder *
