...
class EndEffectorChangingStation:public SolidObject
{
private:
  std::string name;
...
public:
  ...
  void sethadByEndEffectorHolder_ChangingStation (std::vector <
						  EndEffectorHolder *
						  >_hadByEndEffectorHolder_ChangingStation);
  KittingWorkstation *gethasWorkstation_ChangingStation ();
  void sethasWorkstation_ChangingStation (KittingWorkstation *
