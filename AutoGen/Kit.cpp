...
LargeBoxWithKits *
Kit::gethadByKit_LargeBoxWithKits ()
{
...
void
Kit::sethasKit_DesignRef (std::string _hasKit_DesignRef)
{
  this->hasKit_DesignRef = _hasKit_DesignRef;
}

void
Kit::setisKit_Finished (bool _isKit_Finished)
{
...
void
Kit::sethadByKit_LargeBoxWithKits (LargeBoxWithKits *
...
void
Kit::sethasKit_Tray (KitTray * _hasKit_Tray)
{
  this->hasKit_Tray = _hasKit_Tray;
}

void
Kit::sethadByPart_Kit (std::vector < Part * >_hadByPart_Kit)
{
  this->hadByPart_Kit = _hadByPart_Kit;
}

void
Kit::get (std::string name)
{
...
void
Kit::copy (std::map < std::string, std::string > object)
{
  ...
  if (this->hadByKit_LargeBoxWithKits == NULL
      && object["hadByKit_LargeBoxWithKits/LargeBoxWithKits._NAME"] != "")
    {
      this->hadByKit_LargeBoxWithKits =
	new
	LargeBoxWithKits (object
			  ["hadByKit_LargeBoxWithKits/LargeBoxWithKits._NAME"]);
    }
  if (this->hasKit_Tray == NULL && object["hasKit_Tray/KitTray._NAME"] != "")
    {
      this->hasKit_Tray = new KitTray (object["hasKit_Tray/KitTray._NAME"]);
    }
  if (this->hadByPart_Kit.empty ()
      && object["hadByPart_Kit/Part._NAME"] != "")
    {
...
} std::vector < std::string > Kit::Explode (const std::string & str,
					    char separator)
{
