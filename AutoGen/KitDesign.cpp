...
delete(hadByKitDesign_KittingWorkstation);
...
KittingWorkstation* KitDesign::gethadByKitDesign_KittingWorkstation(){
...
void KitDesign::sethadByKitDesign_KittingWorkstation(KittingWorkstation* _hadByKitDesign_KittingWorkstation){
...
if(this->hadByKitDesign_KittingWorkstation== NULL && object["hadByKitDesign_KittingWorkstation/KittingWorkstation._NAME"]!=""){
this->hadByKitDesign_KittingWorkstation = new KittingWorkstation(object["hadByKitDesign_KittingWorkstation/KittingWorkstation._NAME"]);
}
