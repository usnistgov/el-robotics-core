...
class KitDesign:public DataThing
{
private:
...
public:
  ...
  void sethasKitDesign_KitTraySkuRef (std::
  ...
  void sethadByKitDesign_Workstation (KittingWorkstation *
				      _hadByKitDesign_Workstation);
    std::vector < PartRefAndPose * >*gethadByPartRefAndPose_KitDesign ();
  void sethadByPartRefAndPose_KitDesign (std::vector <
					 PartRefAndPose *
