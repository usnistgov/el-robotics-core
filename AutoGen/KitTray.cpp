...
KitTray::gethadByKitTray_LargeBoxWithEmptyKitTrays ()
{
  return hadByKitTray_LargeBoxWithEmptyKitTrays;
}

void
KitTray::sethasKitTray_SkuRef (std::string _hasKitTray_SkuRef)
{
  this->hasKitTray_SkuRef = _hasKitTray_SkuRef;
}

void
KitTray::sethasKitTray_SerialNumber (std::string _hasKitTray_SerialNumber)
{
  this->hasKitTray_SerialNumber = _hasKitTray_SerialNumber;
}

void
KitTray::setdao (DAO * _dao)
{
  this->dao = _dao;
}

void
KitTray::sethasKit_Tray (Kit * _hasKit_Tray)
{
...
void
KitTray::
sethadByKitTray_LargeBoxWithEmptyKitTrays (LargeBoxWithEmptyKitTrays *
...
KitTray::set (std::string name)
{
  ...
  if (hadByKitTray_LargeBoxWithEmptyKitTrays != NULL)
    data["hadByKitTray_LargeBoxWithEmptyKitTrays"] =
      hadByKitTray_LargeBoxWithEmptyKitTrays->getname ();
  dao = new DAO ("KitTray");
  dao->set (data);
  delete (dao);
}
...
void
KitTray::copy (std::map < std::string, std::string > object)
{
  ...
  if (this->hadByKitTray_LargeBoxWithEmptyKitTrays == NULL
      &&
      object
      ["hadByKitTray_LargeBoxWithEmptyKitTrays/LargeBoxWithEmptyKitTrays._NAME"]
      != "")
    {
      this->hadByKitTray_LargeBoxWithEmptyKitTrays =
	new
...
std::vector < std::string > KitTray::Explode (const std::string & str,
					      char separator)
{
