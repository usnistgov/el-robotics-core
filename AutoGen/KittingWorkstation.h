...
class DAO;
class WorkTable;
class KittingWorkstation:public SolidObject
{
private:
...
public:
  ...
  void sethadByKitDesign_Workstation (std::vector <
				      KitDesign *
				      >_hadByKitDesign_Workstation);
  EndEffectorChangingStation *gethasWorkstation_ChangingStation ();
  void sethasWorkstation_ChangingStation (EndEffectorChangingStation *
  ...
  void sethadBySku_Workstation (std::vector <
				StockKeepingUnit * >_hadBySku_Workstation);
