...
class DAO;
class LargeBoxWithEmptyKitTrays:public SolidObject
{
private:
  std::string name;
...
public:
  ...
  void sethasLargeBoxWithEmptyKitTrays_LargeContainer (LargeContainer *
						       _hasLargeBoxWithEmptyKitTrays_LargeContainer);
    std::vector < KitTray * >*gethadByKitTray_LargeBoxWithEmptyKitTrays ();
  void sethadByKitTray_LargeBoxWithEmptyKitTrays (std::vector <
						  KitTray *
