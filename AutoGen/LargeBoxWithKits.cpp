...
int
LargeBoxWithKits::getLargeBoxWithKitsID ()
{
  return LargeBoxWithKitsID;
}

DAO *
LargeBoxWithKits::getdao ()
{
  return dao;
}
...
void
LargeBoxWithKits::sethasLargeBoxWithKits_Capacity (std::
						   string
						   _hasLargeBoxWithKits_Capacity)
{
  this->hasLargeBoxWithKits_Capacity = _hasLargeBoxWithKits_Capacity;
}

void
LargeBoxWithKits::sethasLargeBoxWithKits_KitDesignRef (std::
						       string
...
void
LargeBoxWithKits::setdao (DAO * _dao)
{
  this->dao = _dao;
}

void
LargeBoxWithKits::sethasLargeBoxWithKits_LargeContainer (LargeContainer *
...
void
LargeBoxWithKits::sethadByKit_LargeBoxWithKits (std::vector <
						Kit *
						>_hadByKit_LargeBoxWithKits)
{
  this->hadByKit_LargeBoxWithKits = _hadByKit_LargeBoxWithKits;
}

void
LargeBoxWithKits::get (std::string name)
{
...
void
LargeBoxWithKits::set (std::string name)
{
  ...
  for (unsigned int i = 0; i < hadByKit_LargeBoxWithKits.size (); ++i)
    {
      ss.str ("");
      hadByKit_LargeBoxWithKits[i]->get (hadByKit_LargeBoxWithKits[i]->
					 getname ());
      ss << hadByKit_LargeBoxWithKits[i]->getKitID ();
      data["hadByKit_LargeBoxWithKits"] =
	data["hadByKit_LargeBoxWithKits"] + " " + ss.str ();
    }
  dao = new DAO ("LargeBoxWithKits");
  dao->set (data);
  delete (dao);
...
void
LargeBoxWithKits::copy (std::map < std::string, std::string > object)
{
  ...
  this->hasLargeBoxWithKits_Capacity =
    object["LargeBoxWithKits.hasLargeBoxWithKits_Capacity"];
  this->hasLargeBoxWithKits_KitDesignRef =
    object["LargeBoxWithKits.hasLargeBoxWithKits_KitDesignRef"];
  this->name = object["LargeBoxWithKits._NAME"];
  this->LargeBoxWithKitsID =
    std::atof (object["LargeBoxWithKits.LargeBoxWithKitsID"].c_str ());
  if (this->hasLargeBoxWithKits_LargeContainer == NULL
      && object["hasLargeBoxWithKits_LargeContainer/LargeContainer._NAME"] !=
      "")
    {
      this->hasLargeBoxWithKits_LargeContainer =
	new
	LargeContainer (object
			["hasLargeBoxWithKits_LargeContainer/LargeContainer._NAME"]);
    }
  if (this->hadByKit_LargeBoxWithKits.empty ()
      && object["hadByKit_LargeBoxWithKits/Kit._NAME"] != "")
    {
  ...
  LargeBoxWithKits::Explode (const std::string & str, char separator)
{
