...
class DAO;
class LargeContainer:public BoxyObject
{
private:
...
public:
  ...
  void sethasLargeContainer_SerialNumber (std::
					  string
  ...
  void sethasLargeBoxWithKits_LargeContainer (LargeBoxWithKits *
					      _hasLargeBoxWithKits_LargeContainer);
  LargeBoxWithEmptyKitTrays
    *gethasLargeBoxWithEmptyKitTrays_LargeContainer ();
  void
