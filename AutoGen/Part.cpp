...
Kit *
Part::gethadByPart_Kit ()
{
  return hadByPart_Kit;
}

PartsTrayWithParts *
Part::gethadByPart_PartsTrayWithParts ()
{
  return hadByPart_PartsTrayWithParts;
}

void
Part::sethasPart_SkuRef (std::string _hasPart_SkuRef)
{
  this->hasPart_SkuRef = _hasPart_SkuRef;
}

void
Part::sethasPart_SerialNumber (std::string _hasPart_SerialNumber)
{
  this->hasPart_SerialNumber = _hasPart_SerialNumber;
}

void
Part::setdao (DAO * _dao)
{
  this->dao = _dao;
}

void
Part::sethadByPart_Kit (Kit * _hadByPart_Kit)
{
  this->hadByPart_Kit = _hadByPart_Kit;
}

void
Part::sethadByPart_PartsTrayWithParts (PartsTrayWithParts *
...
Part::set (std::string name)
{
  ...
  if (hadByPart_PartsTrayWithParts != NULL)
    data["hadByPart_PartsTrayWithParts"] =
      hadByPart_PartsTrayWithParts->getname ();
  dao = new DAO ("Part");
  dao->set (data);
  delete (dao);
}
...
void
Part::copy (std::map < std::string, std::string > object)
{
  ...
  if (this->hadByPart_PartsTrayWithParts == NULL
      && object["hadByPart_PartsTrayWithParts/PartsTrayWithParts._NAME"] !=
      "")
    {
      this->hadByPart_PartsTrayWithParts =
	new
	PartsTrayWithParts (object
			    ["hadByPart_PartsTrayWithParts/PartsTrayWithParts._NAME"]);
    }

}

std::vector < std::string > Part::Explode (const std::string & str,
					   char separator)
{
