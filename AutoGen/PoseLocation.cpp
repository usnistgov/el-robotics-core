...
int
PoseLocation::getPoseLocationID ()
{
...
Vector *
PoseLocation::gethasPoseLocation_ZAxis ()
{
  return hasPoseLocation_ZAxis;
}

Vector *
PoseLocation::gethasPoseLocation_XAxis ()
{
  return hasPoseLocation_XAxis;
}

void
PoseLocation::setdao (DAO * _dao)
{
  this->dao = _dao;
}

void
PoseLocation::sethasPoseLocation_Point (Point * _hasPoseLocation_Point)
{
  this->hasPoseLocation_Point = _hasPoseLocation_Point;
}

void
PoseLocation::sethasPoseLocation_ZAxis (Vector * _hasPoseLocation_ZAxis)
{
  this->hasPoseLocation_ZAxis = _hasPoseLocation_ZAxis;
}

void
PoseLocation::sethasPoseLocation_XAxis (Vector * _hasPoseLocation_XAxis)
{
  this->hasPoseLocation_XAxis = _hasPoseLocation_XAxis;
}

void
PoseLocation::get (std::string name)
{
...
void
PoseLocation::set (std::string name)
{
...
void
PoseLocation::copy (std::map < std::string, std::string > object)
{
  ...
  this->PoseLocationID =
    std::atof (object["PoseLocation.PoseLocationID"].c_str ());
  if (this->hasPoseLocation_Point == NULL
      && object["hasPoseLocation_Point/Point._NAME"] != "")
    {
      this->hasPoseLocation_Point =
	new Point (object["hasPoseLocation_Point/Point._NAME"]);
    }
  if (this->hasPoseLocation_ZAxis == NULL
      && object["hasPoseLocation_ZAxis/Vector._NAME"] != "")
    {
      this->hasPoseLocation_ZAxis =
	new Vector (object["hasPoseLocation_ZAxis/Vector._NAME"]);
    }
  if (this->hasPoseLocation_XAxis == NULL
      && object["hasPoseLocation_XAxis/Vector._NAME"] != "")
    {
      this->hasPoseLocation_XAxis =
	new Vector (object["hasPoseLocation_XAxis/Vector._NAME"]);
    }

}

std::vector < std::string > PoseLocation::Explode (const std::string & str,
						   char separator)
{
