...
void PoseOnlyLocation::setPoseOnlyLocationID(int _PoseOnlyLocationID){
this->PoseOnlyLocationID= _PoseOnlyLocationID;
}
...
void PoseOnlyLocation::insert(std::string name){
std::map<std::string, std::string> data;
std::stringstream ss;
data["_Name"]="'" + name + "'";
