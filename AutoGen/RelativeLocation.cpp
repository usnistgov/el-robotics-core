...
int
RelativeLocation::getRelativeLocationID ()
{
  return RelativeLocationID;
}

DAO *
RelativeLocation::getdao ()
{
  return dao;
}

void
RelativeLocation::sethasRelativeLocation_Description (std::
						      string
						      _hasRelativeLocation_Description)
{
  this->hasRelativeLocation_Description = _hasRelativeLocation_Description;
}

void
RelativeLocation::setdao (DAO * _dao)
{
  this->dao = _dao;
}

void
RelativeLocation::get (std::string name)
{
...
void
RelativeLocation::set (std::string name)
{
...
void
RelativeLocation::copy (std::map < std::string, std::string > object)
{
  ...
  this->hasRelativeLocation_Description =
    object["RelativeLocation.hasRelativeLocation_Description"];
  this->name = object["RelativeLocation._NAME"];
  this->RelativeLocationID =
    std::atof (object["RelativeLocation.RelativeLocationID"].c_str ());

} std::vector < std::string >
  RelativeLocation::Explode (const std::string & str, char separator)
{
