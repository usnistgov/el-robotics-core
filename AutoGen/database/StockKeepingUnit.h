...
std::vector<PartsTray*> hasPartsTray_PartSku;
...
std::vector<PartsTray*> gethasPartsTray_PartSku();
void sethasPartsTray_PartSku(std::vector<PartsTray*> _hasPartsTray_PartSku);
