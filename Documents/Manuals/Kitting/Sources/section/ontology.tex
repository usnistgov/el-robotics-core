...
\raisebox{-16 pt}{\includegraphics[width=1.5cm]{Figure/gears2.png}} & \textbf{\textcolor{BrickRed}{HOW TO} -- Write an OWL File from an XML File -- \textcolor{BrickRed}{owlPrinter}}
\end{tabular}
...
\begin{table}[H]
\begin{tabular}{ll} % centered columns (4 columns)
\raisebox{-16 pt}{\includegraphics[width=1.5cm]{Figure/gears2.png}} & \textbf{\textcolor{BrickRed}{HOW TO} -- Check XML Data Files Against XML Schema -- \textcolor{BrickRed}{kittingParser}}
\end{tabular}
\label{table:nonlin} % is used to refer this table in the text
\end{table}
...
\begin{itemize}
 \item[\textcolor{BrickRed}{$\blacksquare$}] \texttt{bin/kittingParser [XML kitting data file in]}
\end{itemize}

For example, the command:
\begin{itemize}
 \item[\textcolor{BrickRed}{$\blacksquare$}] \texttt{bin/kittingParser data/kittingInstances.xml}
\end{itemize}
...
\begin{table}[H]
\begin{tabular}{ll} % centered columns (4 columns)
\raisebox{-16 pt}{\includegraphics[width=1.5cm]{Figure/gears2.png}} & \textbf{\textcolor{BrickRed}{HOW TO} -- Debug the owlprinter -- \textcolor{BrickRed}{compactOwl \& compareOwl}}
\end{tabular}
\label{table:nonlin} % is used to refer this table in the text
\end{table}
