...
\begin{enumerate}
\item \class{Action} -- An \class{Action} has a \class{ActionPrecondition} and an \class{ActionEffect}. An \class{Action} has a \class{ActionParameterList} that contains all the parameters for an action. An \class{Action} has a unique name ().
