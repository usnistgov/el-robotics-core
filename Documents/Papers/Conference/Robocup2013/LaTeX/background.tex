...
%USARSim was originally developed under a National Science Foundation grant to study Robot, Agent, Person Teams in Urban Search and Rescue~\cite{LEWIS.ICHC.2003}. Since that time, it has been turned into a NIST led community supported open source project that provides validated models of robots, sensors, and environments.
...
%\footnote{\url{{http://www.geforce.com/Hardware/Technologies/physx}}} 
...
\begin{figure}[hbt!]
\centering
\subfigure[Dutch Open final,]{\label{DutchOpen}\includegraphics[width=4.4cm]{Figures/Worlds/DutchOpen2012screenshot.png}}\qquad
\subfigure[RoboCup 2012 preliminary,]{\label{3D_World-a}\psfig{file=Figures/Worlds/RoboCup2012preliminary-3.png,width=4.4cm}}\qquad%
\subfigure[NIST main campus,]{\label{3D_World-b}\psfig{file=Figures/Worlds/nist2.jpg,width=4.4cm}}\qquad
\subfigure[Factory.]{\label{3D_World-c}\psfig{file=Figures/Worlds/factory.jpg,width=4.4cm}}
...
%and has been applied to the DARPA Urban Challenge\footnote{\url{http://usarsim.sourceforge.net/wiki/index.php/3._System_Overview}}.
%Challenge (Figure~\ref{3D_World-a}).
...
ROS uses the concept of nodes, messages, topics, services, stacks, and packages. These terms are used throughout the rest of the paper and are detailed below~\cite{Quigley2009}.
\begin{itemize}
