...
rectilinear objects as described by the shape \class{BoxyObject}s in the ontology. As objects get more complex 
...
\texttt{owl:equivalentClass}. This property links the description of the class \class{Intermediate\_State\_Relation}
...
\texttt{robot\_1} in the class \class{Robot}, and created in the \onto{SOAP} ontology.
