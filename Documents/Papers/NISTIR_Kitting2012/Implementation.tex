As previously mentioned, the kitting workstation model has been 
fully defined in each of two
languages: XML schema language , and OWL . Although the two 
...
\begin{enumerate}
\item PDDL domain and problem files are generated from the IEEE RAS  Ontologies for Robotics and Automation Working Group's knowledge representation
and are used by a planner to generate a plan file.
