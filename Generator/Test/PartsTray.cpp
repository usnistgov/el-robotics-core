...
PartsTray::PartsTray(std::string name) :
	BoxyObject(name) {
	dao = NULL;
...
void PartsTray::sethasPartsTray_SerialNumber(
		std::string _hasPartsTray_SerialNumber) {
	this->hasPartsTray_SerialNumber = _hasPartsTray_SerialNumber;
}
void PartsTray::setdao(DAO* _dao) {
	this->dao = _dao;
}
void PartsTray::sethasPartsTrayWithParts_Tray(
		PartsTrayWithParts* _hasPartsTrayWithParts_Tray) {
...
void PartsTray::copy(std::map<std::string, std::string> object) {
	...
	if (this->hasPartsTrayWithParts_Tray == NULL
			&& object["hasPartsTrayWithParts_Tray/PartsTrayWithParts._NAME"]
					!= "") {
		this->hasPartsTrayWithParts_Tray = new PartsTrayWithParts(
				object["hasPartsTrayWithParts_Tray/PartsTrayWithParts._NAME"]);
	}
