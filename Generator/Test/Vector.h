...
public:
	...
	void sethasPartRefAndPose_ZAxis(
			std::vector<PartRefAndPose*> _hasPartRefAndPose_ZAxis);
	std::vector<PartRefAndPose*>* gethasPartRefAndPose_XAxis();
	void sethasPartRefAndPose_XAxis(
			std::vector<PartRefAndPose*> _hasPartRefAndPose_XAxis);
	std::vector<PoseLocation*>* gethasPoseLocation_ZAxis();
	void sethasPoseLocation_ZAxis(
			std::vector<PoseLocation*> _hasPoseLocation_ZAxis);
	std::vector<PoseLocation*>* gethasPoseLocation_XAxis();
	void sethasPoseLocation_XAxis(
			std::vector<PoseLocation*> _hasPoseLocation_XAxis);
