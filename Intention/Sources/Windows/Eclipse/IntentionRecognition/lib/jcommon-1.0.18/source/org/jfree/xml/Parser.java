...
public abstract class Parser extends FrontendDefaultHandler {
     ...
     * of a document (such as finalising a treecheckbox or closing an output
     * file).</p>
     *
     ...
     * of a document (such as allocating the root node of a treecheckbox or
     ...
     * each element (such as finalising a treecheckbox node or writing
     * output to a file).</p>
     *
     * @param uri  the URI.
     ...
     * each element (such as allocating a new treecheckbox node or writing
     * output to a file).</p>
     *
     * @param uri  the URI.
     * @param localName  the element type name.
