(define (problem kitting-problem)
	...
	(:objects
		...
		part_a_1_ir part_a_2_ir part_b_1_ir part_b_2_ir part_b_3_ir part_c_1_ir part_c_2_ir part_c_3_ir part_c_4_ir part_c_5_ir - Part 
	...
	(:init
		...
		(kittray-location-lbwekt kit_tray_3_ir empty_kit_tray_supply)
		...
		(part-location-partstray part_c_4_ir part_c_tray_ir)
		(part-location-partstray part_c_5_ir part_c_tray_ir)
		...
		(endeffector-type-part part_gripper part_c_4_ir)
		(endeffector-type-part part_gripper part_c_5_ir)
		(endeffector-type-kittray tray_gripper kit_tray_3_ir)
		(endeffector-type-kit tray_gripper kit_a2b3c5)
		
		(= (capacity-kit kit_a2b3c5 part_a_tray_ir) 2)
		(= (capacity-kit kit_a2b3c5 part_b_tray_ir) 3)
		(= (capacity-kit kit_a2b3c5 part_c_tray_ir) 5)

		(= (quantity-kit kit_a2b3c5 part_a_tray_ir) 0)
		(= (quantity-kit kit_a2b3c5 part_b_tray_ir) 0)
		(= (quantity-kit kit_a2b3c5 part_c_tray_ir) 0)

		(= (quantity-partstray part_a_tray_ir) 2)
		(= (quantity-partstray part_b_tray_ir) 3)
		(= (quantity-partstray part_c_tray_ir) 5)
		...
		(origin-part part_c_4_ir part_c_tray_ir)
		(origin-part part_c_5_ir part_c_tray_ir)
	)

(:goal
    (and
	(= (quantity-kit kit_a2b3c5 part_a_tray_ir) (capacity-kit kit_a2b3c5 part_a_tray_ir))
	(= (quantity-kit kit_a2b3c5 part_b_tray_ir) (capacity-kit kit_a2b3c5 part_b_tray_ir))
	(= (quantity-kit kit_a2b3c5 part_c_tray_ir) (capacity-kit kit_a2b3c5 part_c_tray_ir))
	(kit-location-lbwk kit_a2b3c5 finished_kit_receiver)
)
)
