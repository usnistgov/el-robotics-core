(define (problem kitting-problem)
	...
	(:objects
		...
		part_a_1_ir part_a_2_ir part_a_3_ir part_a_4_ir part_b_1_ir part_b_2_ir part_b_3_ir part_c_1_ir part_c_2_ir part_c_3_ir - Part 
	...
	(:init
		...
		(kittray-location-lbwekt kit_tray_1_ir empty_kit_tray_supply)
		...
		(endeffector-type-kittray tray_gripper kit_tray_1_ir)
		(endeffector-type-kit tray_gripper kit_a4b3c3)
		
		(= (capacity-kit kit_a4b3c3 part_a_tray_ir) 4)
		(= (capacity-kit kit_a4b3c3 part_b_tray_ir) 3)
		(= (capacity-kit kit_a4b3c3 part_c_tray_ir) 3)

		(= (quantity-kit kit_a4b3c3 part_a_tray_ir) 0)
		(= (quantity-kit kit_a4b3c3 part_b_tray_ir) 0)
		(= (quantity-kit kit_a4b3c3 part_c_tray_ir) 0)
...
(:goal
    (and
	(= (quantity-kit kit_a4b3c3 part_a_tray_ir) (capacity-kit kit_a4b3c3 part_a_tray_ir))
	(= (quantity-kit kit_a4b3c3 part_b_tray_ir) (capacity-kit kit_a4b3c3 part_b_tray_ir))
	(= (quantity-kit kit_a4b3c3 part_c_tray_ir) (capacity-kit kit_a4b3c3 part_c_tray_ir))
	(kit-location-lbwk kit_a4b3c3 finished_kit_receiver)
)
)
