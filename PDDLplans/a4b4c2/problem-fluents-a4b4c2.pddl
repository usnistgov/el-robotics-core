(define (problem kitting-problem)
	...
	(:objects
		...
		kit_tray_2_ir - KitTray
		kit_a4b4c2 - Kit
		empty_kit_tray_supply - LargeBoxWithEmptyKitTrays
		finished_kit_receiver - LargeBoxWithKits 
		work_table_1 - WorkTable
		part_a_tray_ir part_b_tray_ir part_c_tray_ir - PartsTray
		part_a_1_ir part_a_2_ir part_a_3_ir part_a_4_ir part_b_1_ir part_b_2_ir part_b_3_ir part_b_4_ir part_c_1_ir part_c_2_ir - Part 
	...
	(:init
		...
		(kittray-location-lbwekt kit_tray_2_ir empty_kit_tray_supply)
		...
		(part-location-partstray part_b_4_ir part_b_tray_ir)
		...
		(endeffector-type-part part_gripper part_b_4_ir)
		(endeffector-type-part part_gripper part_c_1_ir)
		(endeffector-type-part part_gripper part_c_2_ir)
		(endeffector-type-kittray tray_gripper kit_tray_2_ir)
		(endeffector-type-kit tray_gripper kit_a4b4c2)
		
		(= (capacity-kit kit_a4b4c2 part_a_tray_ir) 4)
		(= (capacity-kit kit_a4b4c2 part_b_tray_ir) 4)
		(= (capacity-kit kit_a4b4c2 part_c_tray_ir) 2)

		(= (quantity-kit kit_a4b4c2 part_a_tray_ir) 0)
		(= (quantity-kit kit_a4b4c2 part_b_tray_ir) 0)
		(= (quantity-kit kit_a4b4c2 part_c_tray_ir) 0)

		(= (quantity-partstray part_a_tray_ir) 4)
		(= (quantity-partstray part_b_tray_ir) 4)
		...
		(origin-part part_b_4_ir part_b_tray_ir)
...
(:goal
    (and
	(= (quantity-kit kit_a4b4c2 part_a_tray_ir) (capacity-kit kit_a4b4c2 part_a_tray_ir))
	(= (quantity-kit kit_a4b4c2 part_b_tray_ir) (capacity-kit kit_a4b4c2 part_b_tray_ir))
	(= (quantity-kit kit_a4b4c2 part_c_tray_ir) (capacity-kit kit_a4b4c2 part_c_tray_ir))
	(kit-location-lbwk kit_a4b4c2 finished_kit_receiver)
)
)
