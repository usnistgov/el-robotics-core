...
\item \stvar{eeffhtype}: \class{EndEffectorHolder}$\mathrm{\times S \rightarrow}$\class{VacuumEffectorSingleCup} $\cup$ \{\textit{nil}\} designates the object an \class{EndEffectorHolder} is holding: A \class{VacuumEffectorSingleCup} or nothing.
\end{itemize}
