...
their particular application. For our simulated kitting workstation, we have fully designed the Domain Specific Information and the Ontology and intend to
 utilize open
...
%\begin{small}
\begin{itemize}
\item A set of {\it Robots \{r$_1$},{\it r$_2$},$\dots$\}: A {\it Robot} in the kitting workstation is a robotic arm that can move objects in order to build \it{KitInstances}.
...
\item A set of {\it EndEffectors} \{$eeff_1$, $eeff_2$,$\dots$\}: $EndEffectors$ are used in a kitting workstation to manipulate $Parts$, $PartTrays$, $KitTrays$, and $KitInstances$.
