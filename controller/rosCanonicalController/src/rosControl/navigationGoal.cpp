...
/**
	...
	Due to what seems to be a bug in the move_arm package, this should always be set to match the frame of the tip link of the planning group being controlled. For instance, if the KR60 arm is being controlled, the target point frame should be set to KR60Arm_link6
*/
...
/**
	@brief Get the move_arm goal object
	
	This method updates the goal transformation
*/
