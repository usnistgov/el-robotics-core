(define (problem kitting-problem)
	...
	(:objects
		...
		part_a_1 part_a_2 part_b_1 part_b_2 part_c_1 - Part 
	...
	(:init
		...
		(part-location part_b_2 part_b_tray)
		...
		(efftype part_gripper part_b_2)
		(efftype part_gripper part_c_1)
		(efftype tray_gripper kit_tray_1)
		(efftype tray_gripper kit_a2b2c1)
	...
	(:goal
	  (and  
	    (part-location part_a_1 kit_a2b2c1) 
	    (part-location part_a_2 kit_a2b2c1) 
	    (part-location part_b_1 kit_a2b2c1)
	    (part-location part_b_2 kit_a2b2c1) 
	    (part-location part_c_1 kit_a2b2c1) 
	    (kit-location kit_a2b2c1 finished_kit_receiver)
	   )
	)
)
