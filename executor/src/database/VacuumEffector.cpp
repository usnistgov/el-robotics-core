...
std::stringstream ss;
data["hasVacuumEffector_CupDiameter"]=hasVacuumEffector_CupDiameter;
data["hasVacuumEffector_Length"]=hasVacuumEffector_Length;
data["name"]=name;
data["VacuumEffectorID"]=VacuumEffectorID;
dao  = new DAO("VacuumEffector");
dao->set(data);
delete (dao);
}
