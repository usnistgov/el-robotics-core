...
\begin{itemize}
\item \stvar{endeffector-location}\\ \class{EndEffector}$\mathrm{\times S\rightarrow}$\class{Robot} $\cup$ \class{EndEffHolder}: designates the location of an \class{EndEffector} in the workstation. An \class{EndEffector} is either attached to a \class{Robot} or placed in an \class{EndEffHolder}.
...
\item \stvar{endeffector-type}\\ \class{EndEffector}$\mathrm{\times S \rightarrow}$\class{KitTray} $\cup$ \class{Kit} $\cup$ \class{Part}: designates the type of object an \class{EndEffector} can hold, i.e., a \class{KitTray}, a \class{Kit}, or a \class{Part}.

\item \stvar{endeffectorholder-holds-endeff}\\ \class{EndEffHolder}$\mathrm{\times S \rightarrow}$\class{EndEffector} $\cup$ \{\}: designates wether an \class{EndEffHolder} is holding an \class{EndEffector} or nothing.

\item \stvar{endeffectorholder-location}\\ \class{EndEffHolder}$\mathrm{\times S \rightarrow}$\class{EndEffChStation}: designates the \class{EndEffChStation} where the \class{EndEffHolder} is located.

\item \stvar{endeffectorchangingstation-has-endeffholder}\\ \class{EndEffChStation}$\mathrm{\times S \rightarrow}$\class{EndEffHolder}: designates the \class{EndEffHolder} the \class{EndEffChStation} contains.
...
\begin{itemize}
 \item \stvar{endeffector-location}
  \begin{enumerate}
  \item \stvar{endeffector-location-robot}(\class{EndEffector},\class{Robot})
    \begin{itemize}
        \item TRUE iff \class{EndEffector} is attached to \class{Robot}
    \end{itemize}
  \item \stvar{endeffector-location-endeffholder}(\class{EndEffector},\class{EndEffHolder})
    \begin{itemize}
        \item TRUE iff \class{EndEffector} is in \class{EndEffHolder}
    \end{itemize}
  \end{enumerate}

 \item \stvar{robot-with-endeffector}
    \begin{enumerate}[resume]
        \item \stvar{robot-with-endeffector}(\class{Robot},\class{EndEffector})
        \begin{itemize}
            \item TRUE iff \class{Robot} is equipped with \class{EndEffector}
        \end{itemize}
  
        \item \stvar{robot-with-no-endeffector}(\class{Robot})
            \begin{itemize}
                \item TRUE iff \class{Robot} is not equipped with any \class{EndEffector}
             \end{itemize}  
  \end{enumerate}

 \item \stvar{on-worktable}
  \begin{enumerate}[resume]
    \item \stvar{on-worktable-kit}(\class{WorkTable},\class{Kit})
        \begin{itemize}
            \item TRUE iff \class{Kit} is on the \class{WorkTable}
        \end{itemize}
  
    \item \stvar{on-worktable-kittray}(\class{WorkTable},\class{KitTray})
        \begin{itemize}
            \item TRUE iff \class{KitTray} is on the \class{WorkTable}
        \end{itemize}
  
    \item \stvar{worktable-empty}(\class{WorkTable})
        \begin{itemize}
            \item TRUE iff there is nothing on the \class{WorkTable}
        \end{itemize}
...
\item \stvar{kit-location}
    \begin{enumerate}[resume]
        \item \stvar{kit-location-lbwk}(\class{Kit},\class{LargeBoxWithKits})
            \begin{itemize}
                \item TRUE iff \class{Kit} is in the \class{LargeBoxWithKits}
            \end{itemize}
  
        \item \stvar{kit-location-worktable}(\class{Kit},\class{WorkTable})
            \begin{itemize}
                \item TRUE iff \class{Kit} is on the \class{WorkTable}
            \end{itemize}
  
        \item \stvar{kit-location-robot}(\class{Kit},\class{Robot})
            \begin{itemize}
                \item TRUE iff \class{Kit} is being held by the \class{Robot}	
            \end{itemize}
    \end{enumerate}

\item \stvar{kittray-location}
    \begin{enumerate}[resume]
        \item \stvar{kittray-location-lbwekt}(\class{KitTray},\class{LargeBoxWithEmptyKitTrays})
            \begin{itemize}
                \item TRUE iff \class{KitTray} is in the \class{LargeBoxWithEmptyKitTrays}	
            \end{itemize}
  
        \item \stvar{kittray-location-robot}(\class{KitTray},\class{Robot}) 
            \begin{itemize}
                \item TRUE iff \class{KitTray} is being held by the \class{Robot}
            \end{itemize}
  
        \item \stvar{kittray-location-worktable}(\class{KitTray},\class{WorkTable}) 
            \begin{itemize}
                \item TRUE iff \class{KitTray} is on the \class{WorkTable}
            \end{itemize}
  \end{enumerate}
...
\item \stvar{part-location}
    \begin{enumerate}[resume]
        \item \stvar{part-location-partstray}(\class{Part},\class{PartsTray})
            \begin{itemize}
                \item TRUE iff \class{Part} is in the \class{PartsTray}
            \end{itemize}
    	
        \item \stvar{part-location-kit}(\class{Part},\class{Kit}) 
            \begin{itemize}
                \item TRUE iff \class{Part} is in the \class{Kit}
            \end{itemize}
    
        \item \stvar{part-location-robot}(\class{Part},\class{Robot}) 
            \begin{itemize}
                \item TRUE iff \class{Part} is being held by the \class{Robot}
            \end{itemize}
    \end{enumerate}

\item \stvar{robot-holds}
    \begin{enumerate}[resume]
        \item \stvar{robot-holds-kittray}(\class{Robot},\class{KitTray}) 
            \begin{itemize}
                \item TRUE iff \class{Robot} is holding a \class{KitTray}
            \end{itemize}
    
        \item \stvar{robot-holds-kit}(\class{Robot},\class{Kit}) 
            \begin{itemize}
                \item TRUE iff \class{Robot} is holding a \class{Kit}
            \end{itemize}
    
        \item \stvar{robot-holds-part}(\class{Robot},\class{Part}) 
            \begin{itemize}
                \item TRUE iff \class{Robot} is holding a \class{Part}
            \end{itemize}
    
        \item \stvar{robot-empty}(\class{Robot}) 
            \begin{itemize}
                \item TRUE iff \class{Robot} is not holding anything
            \end{itemize}
    \end{enumerate}

\item \stvar{lbwk-full}
    \begin{enumerate}[resume]
        \item \stvar{lbwk-not-full}(\class{LargeBoxWithKits}) 
            \begin{itemize}
                \item TRUE iff \class{LargeBoxWithKits} is not full	
            \end{itemize}
  \end{enumerate}

\item \stvar{lbwekt-empty}
    \begin{enumerate}[resume]
        \item \stvar{lbwekt-not-empty}(\class{LargeBoxWithEmptyKitTrays}) 
            \begin{itemize}
                \item TRUE iff \class{LargeBoxWithEmptyKitTrays} is not empty
            \end{itemize}
    \end{enumerate}

\item \stvar{partstray-empty}
    \begin{enumerate}[resume]
        \item \stvar{partstray-not-empty}(\class{PartsTray}) 
            \begin{itemize}
                \item TRUE iff \class{PartsTray} is not empty
            \end{itemize}
    \end{enumerate}

\item \stvar{endeffector-type}
    \begin{enumerate}[resume]
        \item \stvar{endeffeffector-type-kittray}(\class{EndEffector},\class{KitTray}) 
            \begin{itemize}
                \item TRUE iff \class{EndEffector} is capable of holding a \class{KitTray}
            \end{itemize}
    
        \item \stvar{endeffector-type-kit}(\class{EndEffector},\class{Kit}) 
            \begin{itemize}
                \item TRUE iff \class{EndEffector} is capable of holding a \class{Kit}
            \end{itemize}
    
        \item \stvar{endeffector-type-part}(\class{EndEffector},\class{Part}) 
            \begin{itemize}
                \item TRUE iff \class{EndEffector} is capable of holding a \class{Part}
            \end{itemize}
    \end{enumerate}

\item \stvar{endeffectorholder-holds-endeff}
    \begin{enumerate}[resume]
        \item \stvar{endeffectorholder-holds-endeff}(\class{EndEffHolder},\class{EndEffector}) 
            \begin{itemize}
                \item TRUE iff \class{EndEffHolder} is holding \class{EndEffector}
            \end{itemize}
    
        \item \stvar{endeffectorholder-empty}(\class{EndEffHolder}) 
            \begin{itemize}
                \item TRUE iff \class{EndEffHolder} is empty (not holding an \class{EndEffector})
            \end{itemize}
  \end{enumerate}
...
\item \stvar{endeffectorholder-location}
    \begin{enumerate}[resume]
        \item \stvar{endeffectorholder-location}(\class{EndEffHolder},\class{EndEffChStation}) 
            \begin{itemize}
                \item TRUE iff \class{EndEffHolder} is in \class{EndEffChStation}
            \end{itemize}
    \end{enumerate}

\item \stvar{endeffectorchangingstation-has-endeffholder}
    \begin{enumerate}[resume]
        \item \stvar{endeffectorchangingstation-has-endeffholder}(\class{EndEffChStation},\class{EndEffHolder}) 
            \begin{itemize}
                \item TRUE iff \class{EndEffChStation} contains \class{EndEffHolder}
            \end{itemize}
    \end{enumerate}

\item \stvar{found-part}
    \begin{enumerate}[resume]
        \item \stvar{found-part}(\class{Part},\class{PartsTray}) 
            \begin{itemize}
                \item TRUE iff \class{Part} is found in \class{PartsTray}
            \end{itemize}
  \end{enumerate}

\item \stvar{origin-part}
    \begin{enumerate}[resume]
        \item \stvar{origin-part}(\class{Part},\class{PartsTray}) 
            \begin{itemize}
                \item TRUE iff \class{Part} is from \class{PartsTray}
            \end{itemize}
    \end{enumerate}
\end{itemize}
...
\begin{itemize}
 \item \stvar{quantity-parts-in-partstray}
  \begin{itemize}
   \item \stvar{quantity-parts-in-partstray}(\class{PartsTray}) 
   \begin{itemize}
   \item Number of parts in \class{PartsTray}
  \end{itemize}
 ...
 \item \stvar{quantity-parts-in-kit}
  \begin{itemize}
   \item \stvar{quantity-parts-in-kit}(\class{Kit},\class{PartsTray})
   \begin{itemize}
   \item Number of parts from \class{PartsTray} that is in \class{Kit}
  \end{itemize}
  \end{itemize}

     \item \stvar{capacity-parts-in-kit}
  \begin{itemize}
  \item \stvar{capacity-parts-in-kit}(\class{Kit},\class{PartsTray}) 
     \begin{itemize}
   \item Number of parts from \class{PartsTray} that \class{Kit} \textbf{can} contain
  \end{itemize}
  \end{itemize}
\end{itemize}
...
\begin{tabular}{ l|l }
  ...
  \stvarsmall{endeffector-location-robot}(\constsmall{endeff},\constsmall{robot})&\\
  \stvarsmall{worktable-empty}(\constsmall{worktable})& \\
  \stvarsmall{endeffector-type-kittray}(\constsmall{endeff},\constsmall{kittray})&
\end{tabular}
...
\begin{itemize}
 ...
 \item \stvarsmall{robot-with-endeffector}(\const{robot},\constsmall{endeff}): \constsmall{robot} is equipped with \constsmall{endeff}.
 \item \stvarsmall{endeffector-location-robot}(\constsmall{endeff},\constsmall{robot}): The end effector is on the robot's arm.
 ...
 \item \stvarsmall{endeffector-type-kittray}(\constsmall{endeff},\constsmall{kittray}): \constsmall{endeff} in the robot's arm must be capable of handling \constsmall{kittray}.
 \end{itemize}
\item \textit{effects}
 \begin{itemize}
