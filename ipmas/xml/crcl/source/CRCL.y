...
%type <EndCanonTypeVal>               y_EndCanonType_Whole
...
%type <InitCanonTypeVal>              y_InitCanonType_Whole
...
%type <OpenToolChangerTypeVal>        y_OpenToolChangerType_Whole
...
y_CloseGripper_CloseGripperType :
	  ...
	  {$$ = $2;}
	| CLOSEGRIPPERSTART y_CloseGripperType_Whole
	  {$$ = $2;}
	;
...
y_CloseToolChanger_CloseToolChan1003 :
	  ...
	  {$$ = $2;}
	| CLOSETOOLCHANGERSTART y_CloseToolChangerType_Whole
	  {$$ = $2;}
	;
...
y_EndCanon_EndCanonType :
	  ...
	  {$$ = $2;}
	| ENDCANONSTART y_EndCanonType_Whole
	  {$$ = $2;}
	;
...
y_InitCanon_InitCanonType :
	  ...
	  {$$ = $2;}
	| INITCANONSTART y_InitCanonType_Whole
	  {$$ = $2;}
	;
...
y_OpenGripper_OpenGripperType :
	  ...
	  {$$ = $2;}
	| OPENGRIPPERSTART y_OpenGripperType_Whole
	  {$$ = $2;}
	;
...
y_OpenToolChanger_OpenToolChangerType :
	  ...
	  {$$ = $2;}
	| OPENTOOLCHANGERSTART y_OpenToolChangerType_Whole
	  {$$ = $2;}
	;
