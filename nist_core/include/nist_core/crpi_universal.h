...
{
  struct LIBRARY_API universalHandler
  {
    ulapi_mutex_struct *handle;
    bool runThread;
    void *rob;
    ulapi_integer clientID;
    stringstream moveMe;
    robotPose curPose;
    robotAxes curAxes;
    robotIO curIO;
  ...
  //!
  class LIBRARY_API CrpiUniversal
  {
  public:
  ...
  private:
    matrix *forward_, *backward_, *pin_, *pout_;
    double Xtheta_, Ytheta_, Ztheta_;
