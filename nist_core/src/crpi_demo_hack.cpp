...
{
  LIBRARY_API CrpiDemoHack::CrpiDemoHack (char * initPath) :
  ...
  LIBRARY_API CanonReturn CrpiDemoHack::EndCanon (int reason)
  {
  ...
  LIBRARY_API CanonReturn CrpiDemoHack::InitCanon ()
  {
    v1 = arm_->InitCanon ();
    v2 = hand_->InitCanon ();
