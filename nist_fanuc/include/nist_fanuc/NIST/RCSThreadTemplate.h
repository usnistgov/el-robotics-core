...
namespace RCS {
    ...
    public:
        ...
        /*!
         * \brief Threads is a static definition of all the threads that have been created.
         */
        ...
        /*!
         * \brief Start starts the thread which call Init(), and then does Action() loop.
         */
        void Start() {
            _bThread = true;
        ...
        /*!
         * \brief Static StopAll which stops all the threads created in the boost thread group.
         */
        static void StopAll() {
            for (int i = 0; i < Threads().size(); i++)
            {
                std::cout << "Stop Thread = " << Threads().at(i)->Name().c_str() << std::endl;
                Threads().at(i)->Stop();
            }
...
//                boost::this_thread::sleep(boost::posix_time::milliseconds(100));
    ...
    protected:
        ...
        RCS::Timer _timer; /**< RCS timer for coordinating wait and duration of thread */
