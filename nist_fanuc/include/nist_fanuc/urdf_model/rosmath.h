...
urdf::Vector3 _normalize3(const urdf::Vector3 & v0, double epsilon = 0.0001);
double _dist3(const urdf::Vector3 & v0, const urdf::Vector3 & v1);
urdf::Vector3 _lerp3(urdf::Vector3 v1, urdf::Vector3 v2, double scale);
urdf::Vector3 _normal3(const urdf::Vector3 & v);
urdf::Vector3 _projection(urdf::Vector3 v1, urdf::Vector3 v2);
...
inline urdf::Vector3 _normalize3(const urdf::Vector3 & v0, double epsilon) {
    urdf::Vector3 v;
...
inline urdf::Vector3 _projection(urdf::Vector3 v1, urdf::Vector3 v2) {
    urdf::Vector3 v2u = _normalize3(v2);
