...
if(this->hasWorkstation_OtherObstacles.empty() && object["hasWorkstation_OtherObstacles/KittingWorkstation._NAME"]!=""){
temp = Explode(object["hasWorkstation_OtherObstacles/KittingWorkstation._NAME"], ' ' );
for(unsigned int i=0; i<temp.size();i++){
this->hasWorkstation_OtherObstacles.push_back(new KittingWorkstation(temp[i]));
}
}
if(this->hasRobot_WorkVolume.empty() && object["hasRobot_WorkVolume/Robot._NAME"]!=""){
