...
int filt_PC = set_filt_PC/10;//100
int gxrst, gzrst;
double start_time = 0;
double start_exec = 0;
...
int main(int argc, char **argv)
{
  ...
  ROS_ERROR("Please wait for initialization (5s)...");
  start_time = ros::Time::now().toSec();
  while(start_exec < (start_time + 5))
  {    
