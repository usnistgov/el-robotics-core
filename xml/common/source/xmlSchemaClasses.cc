...
An XmlAttributeGroup is always a reference.

*/

XmlAttributeGroup::XmlAttributeGroup()
{
  id = 0;
  name = 0;
  ref = 0;
...
void XmlAttributeGroup::printSelf(FILE * outFile)
{
...
The formatted function returns true if all of the following are true:
 1. Each line is of the text of the XmlDocumentation is indented at least
