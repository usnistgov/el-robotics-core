...
"</"{W}"DesignRef"{W}">"      {ECH; return DESIGNREFEND;}
"<"{W}"DesignRef"             {ECH; return DESIGNREFSTART;}
"</"{W}"EndEffectorHolders"{W}">" {ECH; return ENDEFFECTORHOLDERSEND;}
"<"{W}"EndEffectorHolders"    {ECH; return ENDEFFECTORHOLDERSSTART;}
"</"{W}"EndEffectorRef"{W}">" {ECH; return ENDEFFECTORREFEND;}
"<"{W}"EndEffectorRef"        {ECH; return ENDEFFECTORREFSTART;}
...
"</"{W}"KitDesignRef"{W}">"   {ECH; return KITDESIGNREFEND;}
"<"{W}"KitDesignRef"          {ECH; return KITDESIGNREFSTART;}
"</"{W}"KitDesign"{W}">"      {ECH; return KITDESIGNEND;}
"<"{W}"KitDesign"             {ECH; return KITDESIGNSTART;}
"</"{W}"KitTraySkuRef"{W}">"  {ECH; return KITTRAYSKUREFEND;}
"<"{W}"KitTraySkuRef"         {ECH; return KITTRAYSKUREFSTART;}
...
"</"{W}"PartSkuRef"{W}">"     {ECH; return PARTSKUREFEND;}
"<"{W}"PartSkuRef"            {ECH; return PARTSKUREFSTART;}
...
"</"{W}"Ref"{W}">"            {ECH; return REFEND;}
"<"{W}"Ref"                   {ECH; return REFSTART;}
...
"</"{W}"SkuRef"{W}">"         {ECH; return SKUREFEND;}
"<"{W}"SkuRef"                {ECH; return SKUREFSTART;}
