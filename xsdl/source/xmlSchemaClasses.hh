...
for example:  type="xs:string"  or  name="PhoneExtType"
...
If there is no prefix, the value pref is 0.
...
and XmlAttributeGroups). The newAttribs are arranged alphabetically.
